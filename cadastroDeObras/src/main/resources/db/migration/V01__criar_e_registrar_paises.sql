CREATE TABLE IF NOT EXISTS pais (
        codigo_pais BIGINT(3) unsigned NOT NULL AUTO_INCREMENT,
        nome varchar(50) NOT NULL,
        nome_ingles varchar(50),
        PRIMARY KEY (codigo_pais)
) ENGINE=InnoDB  DEFAULT CHARSET=UTF8MB4 AUTO_INCREMENT=253;



INSERT INTO pais (codigo_pais, nome, nome_ingles) VALUES
